...
class BasicGradingMixin(models.Model):
    ...
    basic_inclusions_1 = models.CharField(max_length=50, related_name="basic_inclusions_1", default="")
    basic_inclusions_2 = models.CharField(max_length=50, related_name="basic_inclusions_2", default="")
    basic_inclusions_3 = models.CharField(max_length=50, related_name="basic_inclusions_3", default="")
    basic_inclusions_final = models.CharField(max_length=50, related_name="basic_inclusions_final", default="")
